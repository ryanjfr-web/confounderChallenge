...
### Post-Surgical Outcomes for Randomized Patients
```{r}
...
### Post-Surgical Outcomes by Patient Severity
```{r}
...
### Post-Surgical Outcomes by Patient Severity (Stratified by Severity)
```{r}
